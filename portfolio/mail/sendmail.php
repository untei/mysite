...
$thanksPage = "http://www.pzweb.net/mail/thanks.html";
...
1.当方への連絡方法
当フォームからの連絡のみ受け付けます。直接、メール送信されたものに対して、お答え致しません。
また、電話連絡も一切、受け付けません。当内容に違反された場合は、退社後、3ケ月以内であっても、
その後の対応は一切、受け付けません。
※御社(株式会社ダイトク)と交わした同意・誓約書には、このメールフォームのURLアドレスしか記載していません。

2.当ページ等について
当ページ及び当ページで使用するメールアドレスは3ケ月後（2021年3月16日）に削除されます。

3.知識不足、技術不足等による当方への問い合わせは有償対応とする。
　　　また、技術的な依頼（ページ作成等）も同様に有償対応。
　　　有償条件：時間単価は10,000円として算出した問合せへの回答に対する見積もりを
　　　納期を含めたpdfファイルにて送付。金額、納期に同意された場合は、その旨、当フォームより連絡。
　　　受領したら、請求書を発行。pdfファイルにて送付。

4.引継ぎに関して
　当方と同等あるいは、それ以上の技術を持った引継ぎ担当者への引継ぎが出来なかったことは、御社の
　引継ぎ手配不足であるので、当方が作成した資料一切を持って引継ぎ完了とする。したがって、資料に
　対する当方への、当フォームからの連絡内容によっては上記の3項の有償対応とする場合がある。

5.当メールフォームについて
　当フォームメールは、当条件に同意しないと連絡できません。当内容に不服とする場合は、
　御社(株式会社ダイトク)と交わした同意・誓約書を無効とし、御社(株式会社ダイトク)と交わした
　同意・誓約書を当方の意見を考慮した内容に改訂することを条件とする場合に対応するものとする。
　なお、正常に送信できるかテストすることを確認する場合であっても、テストとはみなさず、当内容に
　同意したこととしますので、ご注意ください。
